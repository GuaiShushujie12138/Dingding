...
public class Product implements Serializable, Comparable<Product> {
	...
	public Product(long id, String name, double price, String service_fg,
			...
			String feature_images, String images, String bill,
			String start_date, long sale_num, int flag, String explain,
			Publish publish, CategoryDetail cate_detail,
			Set<Evaluate> evaluates, Set<OrderLine> orderlines,
			Set<Report> reports) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "Product [id=" + id + ", name=" + name + ", price=" + price
				...
				+ ", version=" + version + ", stock=" + stock + ", sale_num="
				+ sale_num + ", flag=" + flag + ", publish=" + publish + "]";
	}
