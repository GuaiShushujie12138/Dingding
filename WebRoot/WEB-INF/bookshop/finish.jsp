...
<html>
  ...
  <body>
    ...
    <div class="header3">
    	...
    	<div align="center">
    		<font style="font-size: 25px; color: #C5131E">恭喜,支付成功!订单已生成</font><br/>	<br><br>
    		<a href="javascript:void(0)" onclick="showOrder(${order_id})"><p style="color: white; background-color: #C5131E; font-size: 20px; width: 120px">查看订单</p></a>
    	</div>
    	<br><br>
	<!--脚部-->
    <div class="footer3">
