...
imgSwitch = function(container,options){
	...
	this.index = 0;
	this.Case=[[32,1,1],[4,4,2],[16,1,1],[1,1,0],[1,1,1],[1,1,2],[1,1,3],[1,1,4],[1,1,5],[1,1,6],[1,8,2],[4,2,2],[4,2,0],[8,3,0],/**锟斤拷锟斤拷锟角分革拷锟斤拷*/[4,2,5],[4,1,5],[4,1,3],[1,4,4]];
	this.pos=0;
	this.nums=[];
...
imgSwitch.prototype={
	setOptions:function(options){
		//锟斤拷锟斤拷默锟斤拷值
		this.options={
			Auto:true,//锟角凤拷锟皆讹拷锟斤拷锟斤拷
			Pause:3000,//锟斤拷停锟斤拷时锟斤拷
			Type:1,//锟斤拷锟斤拷锟斤拷锟斤拷
			Navigate:"numberic",//锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟街ｏ拷锟街憋拷为no(锟斤拷),numberic(锟斤拷锟斤拷),picture(图片)
			Width:874,//图片锟侥匡拷锟�
			Height:211,//图片锟侥高讹拷
			Speed:"normal",//转锟斤拷锟斤拷俣锟�
	...
	timeLine:function(play,end,len){
		...
		var s = 0;t=0;//s,t锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷时锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟狡筹拷Inteval
		c = function(f,t){return +f+(t-f)*(s>1?s-Math.floor(s)==0?1:s-Math.floor(s):s)};//锟斤拷锟斤拷t锟斤拷锟斤拷确锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷值锟缴达拷锟叫★拷锟斤拷锟斤拷锟叫★拷锟斤拷
	...
	fxs:[ 
		function(el,x){this.clipDiv(el,x(this.maskHeight,0),x(0,this.maskWidth),x(0,this.maskHeight),x(this.maskWidth,0))},//锟斤拷锟较诧拷锟捷硷拷锟斤拷锟斤拷锟铰诧拷锟斤拷锟斤拷
